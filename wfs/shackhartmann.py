...
class ShackHartmann(wfs.WFS):
    ...
    def findActiveSubaps(self):
        ...
        print(mask)
        print(self.nx_subaps)
        print(self.subap_threshold)
        print(self.nx_subap_pixels)
        print(self.SUBAP_OVERSIZE)
        print(self.nx_guard_pixels)
    ...
    def initFFTs(self):
        ...
        print(self.nx_subap_pixels_oversize)
        print(self.config.fftOversamp)
		#Calculate FFT padding to use
...
#######################################################################
    ...
    def calcFocalPlane(self, intensity=1):
        ...
        #print(self.fft_input_data)
        #print(type(self.interp_efield))
        #print(type(self.interp_subap_coords))
        #print(type(self.nx_subap_interp))
        #print(type(self.fft_input_data))
        #print(type(self.scaledMask))
        #print(type(self.interp_efield[0]))
        #print(type(self.interp_subap_coords[0]))
        #print(type(self.nx_subap_interp))
        #print(type(self.fft_input_data[0]))
        #print(type(self.scaledMask[0]))
