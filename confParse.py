...
class PY_Configurator(object):
    ...
    def calcParams(self):
        ...
        if(self.tel.telLen==0):
            self.sim.pxlScale = (float(self.sim.pupilSize)/self.tel.telDiam)
        elif(self.tel.telWidth==0):
            self.sim.pxlScale = (float(self.sim.pupilSize)/self.tel.telDiam)
        elif(self.tel.telLen>=self.tel.telWidth):
            self.sim.pxlScale = (float(self.sim.pupilSize)/self.tel.telLen)
        else:
            self.sim.pxlScale = (float(self.sim.pupilSize)/self.tel.telWidth)
...
class TelConfig(ConfigObj):
    ...
    Optional:
        ...
        **Parameter**       **Description**                     **Default**
        ------------------  ---------------------------------   -----------
        ``telDiam``         float: Diameter of telescope pupil 
                            in metres                           ``0``
        ``telLen``          float: Length of telescope pupil
                            in meters                           ``0``
        ``telWidth``        float: Width of telescope pupil
                            in meters                           ``0``
    ...
    Optional:
        ...
        **Parameter**        **Description**                     **Default**
        ...
        ``interpOrder``      Order of interpolation for dm,
                             ...
                             rotation.                           ``2``
        ``gaussWidth``       float: Width of Gauss DM actuator
